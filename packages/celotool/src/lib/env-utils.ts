...
export enum envVar {
  ...
  CELO_UBI_DOCKER_IMAGE_REPOSITORY = 'CELO_UBI_DOCKER_IMAGE_REPOSITORY',
  CELO_UBI_DOCKER_IMAGE_TAG = 'CELO_UBI_DOCKER_IMAGE_TAG',
  CELO_UBI_ADDRESS = 'CELO_UBI_ADDRESS',
  CELO_UBI_MNEMONIC = 'CELO_UBI_MNEMONIC',
  CELO_UBI_RPC_HOST = 'CELO_UBI_RPC_HOST',
