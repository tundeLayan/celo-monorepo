...
export enum DynamicEnvVar {
  ...
  ODIS_SIGNER_GCP_CLOUDSQL_CONNECTION_STRING = '{{ context }}_ODIS_SIGNER_GCP_CLOUDSQL_CONNECTION_STRING',
  ODIS_SIGNER_K8S_SERVICE_ACCOUNT = '{{ context }}_ODIS_SIGNER_K8S_SERVICE_ACCOUNT',
