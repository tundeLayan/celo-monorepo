...
Celo is committed to meet the privacy needs of its users. More details about areas for future research can be found in [Privacy Research](https://github.com/celo-org/celo-monorepo/tree/c33a5ef8785cd368bdcd69d6d8af838121a1fd4c/packages/docs/celo-codebase/protocol/identity/privacy-research.md)
