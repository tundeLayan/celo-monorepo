...
Celo has a [lightweight identity protocol](https://github.com/celo-org/celo-monorepo/tree/c33a5ef8785cd368bdcd69d6d8af838121a1fd4c/celo-codebase/protocol/identity/README.md) that allows users to address each other via their phone number instead of addressses that Celo wallets should implement. Since user privacy is important, Celo wallets should leverage the built-in [Phone Number Privacy protocol](https://github.com/celo-org/celo-monorepo/tree/c33a5ef8785cd368bdcd69d6d8af838121a1fd4c/celo-codebase/protocol/identity/phone-number-privacy/README.md) to protect against large-scale harvesting of user phone numbers.
